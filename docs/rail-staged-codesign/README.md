...
The app is a self-contained offline HTML file: [`../../web_apps/rail-staged-codesign.html`](../../web_apps/rail-staged-codesign.html). The [method note](../rail-staged-codesign-method.md) defines the model and claim boundaries.
...
```sh
node docs/rail-staged-codesign/verify.mjs
```
